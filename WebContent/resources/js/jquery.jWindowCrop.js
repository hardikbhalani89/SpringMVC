...
(function($){
	...
	$.jWindowCrop = function(image, options){
		...
		base.init = function(){
			...
			base.$image.addClass('jwc_image').wrap('<div class="outerframe"><div class="jwc_frame" />'); // wrap image in frame
			base.$image.before('<div class="top-outer">','<div class="left-outer">','<div class="right-outer">', '<div class="bottom-outer">')
			base.$frame = base.$image.parent();
//			base.$frame.append('<div class="jwc_loader">' + base.options.loadingText + '</div>');
		//	base.$frame.append('<div class="jwc_controls" style="display:'+(base.options.showControlsOnStart ? 'block' : //'none')+';"><span></span><a href="#" class="jwc_zoom_in"></a><a href="#" class="jwc_zoom_out"></a></div>');
			base.$frame.css({'position': 'relative', 'width': base.options.targetWidth, 'height': base.options.targetHeight});
			...
			/*if(base.$image.width()<300 && base.$image.height()<300){
				base.$image.css({'width': parseInt(base.$image.width())*2});
			}*/
		...
		function initializeDimensions() {
			if(base.originalWidth == 0) {
					/*if(base.$image.width()!=0 && base.$image.width()<300 && base.$image.height()!=0 && base.$image.height()<300){
						base.$image.css({'width': parseInt(base.$image.width())*2});
					}*/
